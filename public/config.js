        ...
        children: [{
            ...
            "option": {
                ...
                "echartFormatter": "(data)=>{\n" +
                    ...
                    "    backgroundColor: '#000',\n" +
                    "    globe: {\n" +
                    "        baseTexture: '/img/gl/earth.jpg',\n" +
                    "        heightTexture: '/img/gl/bathymetry_bw_composite_4k.jpg',\n" +
                    "\n" +
                    "        displacementScale: 0.1,\n" +
                    "\n" +
                    "        shading: 'lambert',\n" +
                    "\n" +
                    "        environment:  '/img/gl/starfield.jpg',\n" +
                    "\n" +
                    "        light: {\n" +
                    "            ambient: {\n" +
                    "                intensity: 0.1\n" +
                    ...
                    "            type: 'blend',\n" +
                    "            blendTo: 'emission',\n" +
                    "            texture: '/img/gl/night.jpg'\n" +
                    "        }, {\n" +
                    "            type: 'overlay',\n" +
                    "            texture: '/img/gl/clouds.png',\n" +
                    "            shading: 'lambert',\n" +
                    "            distance: 5\n" +
                    "        }]\n" +
                    "    },\n" +
