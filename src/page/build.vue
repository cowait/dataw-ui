<template>
  <div class="build">
                ...
                <el-form-item label="大屏大小">
                  <div class="flex">
                    <avue-input-number style="width:130px"
                                       v-model="config.width"></avue-input-number>
                    &nbsp;x&nbsp;
                    <avue-input-number style="width:130px"
                                       v-model="config.height"></avue-input-number>
                  </div>
                </el-form-item>
              ...
              <el-form label-width="120px"
                ...
                <template v-else-if="isJava">
                  <el-form-item label="调用类型">
                    <avue-select v-model="activeObj.javaMethod"
                                 :dic="dicOption.javaMethod"></avue-select>
                  </el-form-item>
                  <el-form-item label="Bean名称">
                    <el-input v-model="activeObj.javaBeanName">
                    </el-input>
                  </el-form-item>
                  <el-form-item label="方法名称">
                    <el-input v-model="activeObj.javaBeanMethodName">
                    </el-input>
                  </el-form-item>
                </template>
        ...
        <template v-else-if="isMqtt">
          ...
          <el-form-item label="MQTT配置">
            ...
            <el-button size="small"
                       type="primary"
                       icon="el-icon-edit"
                       @click="openCode('mqttConfig','配置项')">编辑</el-button>
          </el-form-item>
        </template>
        <template v-else-if="isJava">
          <el-form-item label="调用类型">
          ...
          <el-form-item label="请求参数">
            <avue-array v-model="activeObj.javaParams"
                        placeholder="请输入参数"></avue-array>
          </el-form-item>
        </template>
    ...
    <el-dialog title="数据集"
               ...
               width="60%">
      <MagicApis @change="handleApiChange"
                 :menu="false"></MagicApis>
      <span slot="footer"
            class="dialog-footer">
        <el-button type="primary"
...
import MagicApis from './list/magic-apis'
...
export default {
  ...
  methods: {
    ...
    handleApiSubmit () {
      this.activeObj.url = this.api.item.path
      this.activeObj.dataMethod = this.api.item.method.toLowerCase()
      this.api.box = false;
      this.api.item = {}
      this.handleRes()
    },
