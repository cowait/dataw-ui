...
export const dicOption = {
  ...
  dataType: [{ label: '静态数据', value: 0 }, { label: 'HTTP动态数据', value: 1 }, { label: 'SQL数据', value: 2 }, { label: 'WS实时数据', value: 3 }, { label: 'MQTT实时数据', value: 4 }, { label: 'Java动态数据', value: 5 }, { label: 'Record数据集', value: 6 }],
  ...
  javaMethod: [{ label: 'SpringBean', value: 'bean' }, { label: '反射', value: 'reflection' }],
